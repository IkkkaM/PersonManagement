...
public class PersonUpdateRequestValidator : AbstractValidator<PersonUpdateRequest>
{
    ...
    private readonly IStringLocalizer<PersonUpdateRequestValidator> _localizer;
    private int _currentPersonId;

    public PersonUpdateRequestValidator(IPersonRepository personRepository, IStringLocalizer<PersonUpdateRequestValidator> localizer)
    {
    ...
    private bool HaveConsistentNameLanguage(PersonUpdateRequest request)
    {
